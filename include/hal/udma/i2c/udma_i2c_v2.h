...
#define UDMA_I2C_RX_ADDR(id)        (ARCHI_UDMA_ADDR + UDMA_I2C_OFFSET(id) + UDMA_CHANNEL_RX_OFFSET)
#define UDMA_I2C_RX_SIZE_ADDR(id)      UDMA_I2C_RX_ADDR(id) + 0x4
#define UDMA_I2C_RX_CFG_ADDR(id)      UDMA_I2C_RX_ADDR(id) + 0x8
...
#define UDMA_I2C_CMD_SIZE_ADDR(id)      UDMA_I2C_CMD_ADDR(id) + 0x4
#define UDMA_I2C_CMD_CFG_ADDR(id)      UDMA_I2C_CMD_ADDR(id) + 0x8
